...
import getImage from './getImage1';
        ...
        <View style={styles.row}>
          ...
          <View style={styles.textContainer}>
            ...
            {/*</Text>*/}
              ...
              <Text style={styles.petAge} numberOfLines={1}> Age : 2 </Text>

              <Text style={styles.petLove} numberOfLines={1}>
                  <Icon name="heart" size={30} color="#4F8EF7" />
                    7
              </Text>
